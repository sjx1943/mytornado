...
2024-11-2 修复了广播信息中的商品详情页，在详情页中可以跳转至商品上传者的个人主页。但还是无法实时聊天，对话框中没有任何提示。
下一步， 在聊天室点击对应用户进行对话，并在“我的消息”中看到消息提醒。
此外，买家点击想要某个商品后，卖家可在主页看到消息提醒，并实现消息的自动刷新。 

卖家获得提醒后可调用聊天chat控制器打开聊天对话框，并在聊天对话框里看到历史消息，并相互发送聊天信息，交易成功后双方确认，卖家更新数据库中的商品数量和状态。
